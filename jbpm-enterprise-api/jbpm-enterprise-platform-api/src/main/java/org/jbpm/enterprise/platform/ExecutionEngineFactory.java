 ...
 * 	<li>builds default <code>ExecutionEngineMapperStrategy</code> instance</li>
...
public interface ExecutionEngineFactory {
	...
	/**
	 * Builds <code>ExecutionEngine</code> based on supplied configuration, which disables automatic resource resolving mechanism
	 * and instructs the engine to use provided <code>ExecutionEngineMapperStrategy</code> instead of the default one. With provided callback instance caller
